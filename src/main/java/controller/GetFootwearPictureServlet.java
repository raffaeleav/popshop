...
@WebServlet("/get-foot-picture")
public class GetFootwearPictureServlet extends HttpServlet {

    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        String id = request.getParameter("id");
        FootwearBeanDAO service = new FootwearBeanDAO();
        FootwearBean footwearBean = service.doRetrieveById(Integer.parseInt(id));

        String filePath = "C:\\PopShop\\catalogo\\" + File.separator + footwearBean.getImage();
